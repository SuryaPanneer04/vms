    ...
    <div class="container-fluid content-animate">
        <div class="row mb-4">
            <div class="col-12 d-flex justify-content-between align-items-center">
                <h4 class="fw-bold mb-0 text-primary"><i class="fas fa-file-import me-2"></i> Employee Data Import</h4>
                <button type="button" class="btn btn-success shadow-sm" data-bs-toggle="modal" data-bs-target="#importModal">
                    <i class="fas fa-file-excel me-2"></i> Import New Excel
                </button>
            </div>
        </div>
            ...
            <div class="card-body">
                <form method="GET" class="row g-3">
                    ...
                    <div class="col-md-3 d-flex align-items-end">
                        ...
                        <a href="employee_import.php" class="btn btn-light"><i class="fas fa-sync-alt"></i></a>
                    </div>
                </form>
            </div>
        </div>
